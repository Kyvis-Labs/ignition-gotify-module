...
public class GotifyNotificationProfileType extends AlarmNotificationProfileType {
    public static final String TYPE_ID = "GotifyType";
    public static final ContactType GOTIFY =
            new ContactType("Gotify", new LocalizedString("GotifyNotification.ContactType.Gotify"));

    public GotifyNotificationProfileType() {
        super(TYPE_ID,
                "GotifyNotification." + "GotifyNotificationProfileType.Name",
                "GotifyNotification." + "GotifyNotificationProfileType.Description");
    }

    @Override
    public RecordMeta<? extends PersistentRecord> getSettingsRecordType() {
        return GotifyNotificationProfileSettings.META;
    }
    ...
    public AlarmNotificationProfile createNewProfile(GatewayContext context,
        ...
        GotifyNotificationProfileSettings settings = findProfileSettingsRecord(context, profileRecord);
        ...
        return new GotifyNotificationProfile(context, profileRecord, settings);
    }
